...
$global:power_plan_name = 'MyPowerSaver' # The powerplan used to control the temperature
...
# Temperatures:
$global:target_temp = 88 # ----------------------- # in celcius (default 90), the CPU temp the script will try reaching and balance the CPU max state around
...
# Execution
$global:step_size = 1 # ========================== # in % (default 1), each execution step how much will the CPU state increase/decrease (if it does so)

# Time between execution / steps
$global:time_beteween_steps_increase_max = 6000    # in milliseconds (default 6000), explained in easing_range
$global:time_beteween_steps_increase_min = 2000    # in milliseconds (default 2000), explained in easing_range

$global:time_beteween_steps_decrease_max = 5000    # in milliseconds (default 5000), explained in easing_range
$global:time_beteween_steps_decrease_min = 1000    # in milliseconds (default 1000), explained in easing_range
